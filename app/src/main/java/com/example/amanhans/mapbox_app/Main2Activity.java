...
import com.example.amanhans.mapbox_app.adapter.LocationRecyclerViewAdapter;
import com.example.amanhans.mapbox_app.model.IndividualLocation;
import com.example.amanhans.mapbox_app.util.LinearLayoutManagerWithSmoothScroller;
...
import static com.example.amanhans.mapbox_app.util.StringConstants.SELECTED_THEME;
...
//                    -73.87063900287112)).build();
    private static final LatLng MOCK_DEVICE_LOCATION_LAT_LNG = new LatLng(32.705330, 74.879997);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chosenTheme = getIntent().getIntExtra(SELECTED_THEME, R.style.AppTheme_Purple);
        ...
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(final MapboxMap mapboxMap) {
                ...
                customThemeManager = new CustomThemeManager(chosenTheme, Main2Activity.this);
...
//                        mapboxMap.setLatLngBoundsForCameraTarget(LOCKED_MAP_CAMERA_BOUNDS);
                        ...
                        if (featureList != null) {
                            ...
                            Toast.makeText(Main2Activity.this, "Click on a card", Toast.LENGTH_SHORT).show();
    ...
    private void getInformationFromDirectionsApi(Point destinationPoint,
        ...
        directionsApiClient.enqueueCall(new Callback<DirectionsResponse>() {
            ...
            public void onFailure(Call<DirectionsResponse> call, Throwable throwable) {
                Toast.makeText(Main2Activity.this, R.string.failure_to_retrieve, Toast.LENGTH_LONG).show();
            }
        });
    }
